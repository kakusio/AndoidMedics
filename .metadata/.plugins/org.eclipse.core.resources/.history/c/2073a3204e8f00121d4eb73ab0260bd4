...
public class PostToUrl extends AsyncTask<Void, Void, String> {
	...
	public PostToUrl(String URL, String IpAdd, final Toast toastPeticionExitosa) {
		this.URL = URL;
		this.IpAdd = IpAdd;
	...
	protected String doInBackground(Void... params) {
		...
		HttpPost httpPost = new HttpPost("http://" + IpAdd + ":4001/api/user?id=" + static_data.Id + "&url=" + encryptEncode);
		String text = null;
		try {
