...
public class AddExamen extends CustomActivityClass {
	ArrayList<Analisis> list = new ArrayList<Analisis>();
...
//		new AsyncWebAddExamen(AddExamen.this).execute(agenda_url);
		...
		list.add(new Analisis("Tension arterial","37926D73-703D-E211-9869-047D7BC028BB"));
		list.add(new Analisis("Glicemia","38926D73-703D-E211-9869-047D7BC028BB"));
