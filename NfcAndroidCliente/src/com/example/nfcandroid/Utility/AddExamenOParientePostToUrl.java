...
public class AddExamenOParientePostToUrl extends AsyncTask<Void, Void, String> {
	private ProgressDialog progDialog;
	String URL;
	CustomActivityClass activity;
	public AddExamenOParientePostToUrl(String URL, final CustomActivityClass medics) {
		this.URL = URL;
